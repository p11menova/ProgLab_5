        ...
        try {
            ...
            if (!(newElem == null)) {
                if (newElem.compareTo(this.collectionManager.getById(id)) > 0) {
                    ...
                    Console.println("введенный элемент меньше предыдущего. произошла замена!");
                } else Console.println("введенный элемент не меньше предыдущего.) все осталось как было.");
            }
            return true;
